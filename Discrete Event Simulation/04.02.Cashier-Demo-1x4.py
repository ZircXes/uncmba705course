"""
Example 04.02
Model for 1x4 Line and Cashier for Grocery StopIteration
...
MODEL_NAME = "Grocery Store Demo: 1 Line and 4 Cashiers"
...
# Grocery Store Setup
cashier = simpy.Resource(env, capacity=4) # CHANGE A02
